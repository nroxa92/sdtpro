...
final sensorDatabase = <BaseSensorData>[
  ...
  NtcSensor(
    id: 'NTC-GENERIC',
    name: 'Senzori Temperature (Voda/Ulje/Zrak/Auspuh)',
    category: TestCategory.sensors,
    ...
    currentTest: CurrentTest(refMin: 0.0014, refMax: 0.0023), // 1.4mA = 0.0014A
    ntcTable: [
  ...
  PiezoSensor(
    ...
    resistanceTest: ResistanceTest(refMin: 4, refMax: 6, unit: "MΩ"), // 5 MΩ
    liveSignal: 'Mali AC napon pri vibraciji motora. Greška > 5000 RPM.',
  ),

  // --- 3-PIN SENZORI / KOMPONENTE ---
  HallSensor(
    id: 'CAPS-01',
...
// =======================================================================
// OSTATAK DATOTEKE NE DIRAJTE
// Ovaj kod automatski grupira sve senzore koje ste unijeli gore.
